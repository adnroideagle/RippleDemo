...
public class DemoListActivity extends FragmentActivity implements
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		listView.setAdapter(new ArrayAdapter<String>(this,
				R.layout.demo_list_item, android.R.id.text1, data));
		...
		listView.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener() {
			...
			public boolean onItemLongClick(AdapterView<?> parent, View view,
				...
				if (position % 2 == 0) {
					Toast.makeText(DemoListActivity.this,
							"long item: " + position + " and not consumed",
							Toast.LENGTH_SHORT).show();
					return false;
				}
				Toast.makeText(DemoListActivity.this,
						"long item: " + position + " and consumed",
						Toast.LENGTH_SHORT).show();
				return true;
			}
		});
	...
	public void onItemClick(AdapterView<?> parent, View view, int position,
			long id) {
		Toast.makeText(this, "Rippled item: " + position, Toast.LENGTH_SHORT)
				.show();
	}
